...
namespace CountwareTraffic.Services.Companies.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger()
               .UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CountwareTraffic.Services.Companies.Api v1"))
               .UseHttpsRedirection()
               .UseRouting()
               .UseAuthentication()
               .UseAuthorization()
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            {
                swagger.SwaggerDoc("v1", new OpenApiInfo { Title = "CountwareTraffic.Services.Companies.Api", Version = "v1" });
