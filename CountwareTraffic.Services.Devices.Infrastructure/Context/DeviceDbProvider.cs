...
{
    public class DeviceDbProvider : InterceptorDefination, IScopedSelfDependency
    {
        ...
        public DeviceDbProvider(IQueueEventMapper queueEventMapper, IIdentityService identityService, IQueueService queueService, ICommandDispatcher commandDispatcher)
        {
