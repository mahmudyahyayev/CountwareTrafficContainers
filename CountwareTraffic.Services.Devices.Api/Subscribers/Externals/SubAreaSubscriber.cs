...
namespace CountwareTraffic.Services.Devices.Api
{
    public class SubAreaSubscriber : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _queueService.Subscribe<SubAreaCreatedConsumer>(Queues.CountwareTrafficCompaniesSubAreaCreated, template);
            _queueService.Subscribe<SubAreaChangedConsumer>(Queues.CountwareTrafficCompaniesSubAreaChanged, template);
            _queueService.Subscribe<SubAreaDeletedConsumer>(Queues.CountwareTrafficCompaniesSubAreaDeleted, template);
